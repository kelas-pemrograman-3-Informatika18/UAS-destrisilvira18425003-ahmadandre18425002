<template>
    <q-layout>
        <q-page-container>
            <q-page padding class="bg-light-green-2">
                <div class="row">
                    <q-card class="fixed-center col-md-4 col-xs-12">
                        <q-card-section>
                            ...
                            <q-form @submit="onSubmit">
                                ...
                                label="E-mail"
                                :rules="[
                                val => val && val.length > 0 || 'Masukkan E-mail'
                                ]"/>
                                ...
                                <q-card-section>
                                    <div class="q-gutter-md">
                                        <q-btn label="Registrasi" unelevated type="submit" color="light-green" class="full-width"/>
